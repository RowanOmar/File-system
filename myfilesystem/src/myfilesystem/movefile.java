 ...
 * @author Rawan
 */
public class movefile extends JPanel{
    ...
    public movefile() {
        ...
        label2=new JLabel("Enter the Directory you want to move from ");
        ...
        add(label2);
         ...
         label3=new JLabel("Enter the Directory you want to move to ");
    ...
    private class myhandeler implements ActionListener{
        ...
        Object pressed=e.getSource();
            ...
            if(pressed.equals(button1))
            {
                ...
                filee.movefile(filename,from,to);
